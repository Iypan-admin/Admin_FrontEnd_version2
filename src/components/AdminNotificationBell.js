...
import { getAdminNotifications, markAdminNotificationAsRead } from '../services/Api';
...
const AdminNotificationBell = () => {
  ...
  const handleMarkAsRead = async (notificationId, e) => {
    ...
    try {
      await markAdminNotificationAsRead(notificationId, token);
      ...
      {showDropdown && (
        <>
          ...
          <div className="absolute right-0 mt-2 w-80 sm:w-96 bg-white rounded-lg shadow-xl border border-gray-200 z-50 overflow-hidden">
            {/* Header - Matching Manager Bell Design */}
