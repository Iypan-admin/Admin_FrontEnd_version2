...
import { editCenterName } from '../services/Api';

const EditCenterSlidePanel = ({ isOpen, onClose, onSuccess, center }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await editCenterName({ centerId: center.center_id, newCenterName: centerName.trim() }, token);
      onSuccess();
      handleClose();
    } catch (error) {
      setError(error.message || 'Failed to edit center name');
    } finally {
      setLoading(false);
    }
  };
        ...
        <div className="h-full bg-white shadow-2xl flex flex-col overflow-hidden">
            ...
            <div className="flex items-start justify-between">
              <div className="flex items-center gap-4 flex-1 min-w-0">
                ...
                <div className="flex-1 min-w-0">
                  <h2 className="text-xl sm:text-2xl font-bold mb-1 truncate">Edit Center Name</h2>
                  <p className="text-blue-100 text-sm truncate">Update center information</p>
                </div>
              </div>
              <button
                onClick={handleClose}
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="bg-blue-50 border border-blue-200 rounded-xl p-4">
                  <div className="flex items-start">
                    ...
                    <div>
                      <p className="text-sm text-blue-800 font-medium">Current Center</p>
                      <p className="text-xs text-blue-600 mt-1">
                        Center ID: {center.center_id?.slice(0, 8)}...
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-white rounded-xl border border-gray-200 p-6 shadow-sm">
                  ...
                  <p className="mt-2 text-xs text-gray-500">
                    Update the center name. This will reflect across all related records.
                  </p>
                </div>
                ...
                <div className="bg-blue-50 border border-blue-200 rounded-xl p-4">
                  <div className="flex items-start">
                    ...
                    <div>
                      <p className="text-sm text-blue-800 font-medium">Center Update</p>
                      <p className="text-xs text-blue-600 mt-1">
                        Changes will be saved immediately and reflected in the system.
                      </p>
                    </div>
                  </div>
                </div>
          ...
          <div className="bg-gray-50 px-6 py-4 flex justify-end gap-3 border-t border-gray-200 flex-shrink-0">
            ...
            <button
              ...
              disabled={loading || !centerName.trim() || centerName.trim() === center.center_name}
...
export default EditCenterSlidePanel;
