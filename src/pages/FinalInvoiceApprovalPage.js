            ...
            <div className="bg-gradient-to-r from-purple-600 to-indigo-700 rounded-2xl shadow-xl p-6 sm:p-8 text-white">
              <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-6">
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    <h1 className="text-3xl sm:text-4xl font-bold mb-2">Final Invoice Approval</h1>
                    <p className="text-purple-100 text-lg">
                      Final review and approval of finance accepted invoices
                    </p>
                  </div>
                </div>
              </div>
                                  ...
                                  <div className="flex items-center space-x-2">
                                    {invoice.pdf_url && (
                                      <a
                                        ...
                                        className="inline-flex items-center px-3 py-1 bg-purple-600 text-white rounded-lg hover:bg-purple-700 transition-colors duration-200 text-xs font-medium"
                                      >
                                    ...
                                    <div className="bg-white rounded-lg p-6 shadow-sm border border-gray-200">
                                      ...
                                      {isLoading ? (
                                        <div className="text-center py-8">
                                          <div className="animate-spin rounded-full h-8 w-8 border-4 border-purple-200 border-t-purple-600 mx-auto mb-2"></div>
                                            ...
                                            <tbody className="bg-white divide-y divide-gray-200">
                                              {invoiceItems.map((item, index) => (
                                                <tr key={item.item_id} className="hover:bg-gray-50">
                                                  ...
                                                  <td className="px-3 py-3 text-sm text-purple-600">₹{item.net_amount?.toLocaleString('en-IN', { minimumFractionDigits: 2 }) || '0.00'}</td>
