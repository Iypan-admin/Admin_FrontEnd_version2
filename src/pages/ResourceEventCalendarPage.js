...
const ResourceEventCalendarPage = () => {
                  ...
                  <>
                    ...
                    <div className="absolute right-0 mt-2 w-80 bg-white rounded-lg shadow-xl border border-gray-200 z-50 overflow-hidden">
                      <div className="px-4 py-4 border-b border-gray-200 bg-gradient-to-r from-blue-50 to-blue-50">
                        <h3 className="font-bold text-gray-800 text-base">Welcome, {getDisplayName() || 'Resource Manager'}</h3>
                      ...
                      <div className="py-2">
                        <button
                          onClick={() => {
                            navigate('/resource-manager/account-settings'); // Assuming this page exists or will be created
...
export default ResourceEventCalendarPage;
