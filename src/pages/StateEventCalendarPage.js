...
import { getCurrentUserProfile, getEventsByDateRange } from '../services/Api';

const StateEventCalendarPage = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex" style={{ marginLeft: isMobile ? '0' : (sidebarWidth === '6rem' ? '96px' : '256px'), transition: 'margin-left 0.3s ease' }}>
            ...
            <div className="flex items-center gap-2 sm:gap-3 md:gap-4 min-w-0 flex-1">
              <div className="flex items-center gap-2 sm:gap-3 min-w-0">
                ...
                <div className="min-w-0">
                  <h1 className="text-base sm:text-xl md:text-2xl font-bold text-gray-800 truncate">Event Calendar</h1>
                  <p className="text-xs sm:text-sm text-gray-500 mt-0.5 hidden sm:block">View academic events and schedules</p>
                </div>
              </div>
            </div>
                ...
                <button onClick={() => setShowProfileDropdown(!showProfileDropdown)} className="flex items-center focus:outline-none">
                  {profileInfo?.profile_picture ? (
                    ...
                    <div className="w-8 h-8 sm:w-10 sm:h-10 bg-gradient-to-br from-blue-500 to-blue-600 rounded-full flex items-center justify-center text-white font-bold text-sm sm:text-base cursor-pointer hover:ring-2 hover:ring-blue-300 transition-all">
                      {getDisplayName()?.charAt(0).toUpperCase() || 'S'}
                    </div>
                  )}
                </button>
                  ...
                  <>
                    ...
                    <div className="absolute right-0 mt-2 w-80 bg-white rounded-lg shadow-xl border border-gray-200 z-50 overflow-hidden">
                      <div className="px-4 py-4 border-b border-gray-200 bg-gradient-to-r from-blue-50 to-blue-50">
                        <h3 className="font-bold text-gray-800 text-base">Welcome, {getDisplayName() || 'State Admin'}</h3>
                        <p className="text-sm text-gray-500 mt-1">State Admin</p>
                      </div>
...
export default StateEventCalendarPage;
