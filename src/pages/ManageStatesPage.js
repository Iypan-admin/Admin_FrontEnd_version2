...
import { getAllStates, getCurrentUserProfile } from "../services/Api";
import CreateStateSlidePanel from "../components/CreateStateSlidePanel";
import EditStateSlidePanel from "../components/EditStateSlidePanel";
...
const ManageStatesPage = () => {
  ...
  // Fetch states with background polling
  const fetchStates = useCallback(async (isInitialLoad = false) => {
    try {
      if (isInitialLoad) {
        setLoading(true);
      }
  ...
  const filteredStates = states.filter(state =>
    ...
    state.admin_name?.toLowerCase().includes(searchTerm.toLowerCase())
  );
          ...
          <div className="p-4 sm:p-6 lg:p-8">
            <div className="flex items-center justify-center min-h-[60vh]">
              <div className="text-center">
                ...
                <h3 className="text-xl font-semibold text-gray-700 mb-2">Loading States</h3>
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex">
              ...
              <div className="flex items-center space-x-3 sm:space-x-4">
                ...
                <div>
                  ...
                  <p className="text-xs sm:text-sm text-gray-500 mt-1">
                    Organize and manage state configurations
                  </p>
                </div>
              </div>
                    ...
                    <>
                      ...
                      <div className="absolute right-0 mt-2 w-80 bg-white rounded-lg shadow-xl border border-gray-200 z-50 overflow-hidden">
                        ...
                        <div className="px-4 py-4 border-b border-gray-200 bg-gradient-to-r from-blue-50 to-indigo-50">
                          ...
                          <p className="text-sm text-gray-500 mt-1">{decodedToken?.role || "Guest"}</p>
                        </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-6">
              ...
              <div className="bg-gradient-to-br from-blue-500 to-blue-600 rounded-xl shadow-lg p-4 sm:p-6 relative overflow-hidden">
                ...
                <div className="relative z-10">
                  ...
                  <p className="text-blue-100 text-xs sm:text-sm font-medium mb-1">Total States</p>
                  <p className="text-white text-3xl sm:text-4xl font-bold">{states.length}</p>
                </div>
              </div>
              ...
              <div className="bg-gradient-to-br from-green-500 to-green-600 rounded-xl shadow-lg p-4 sm:p-6 relative overflow-hidden">
                ...
                <div className="relative z-10">
                  ...
                  <p className="text-green-100 text-xs sm:text-sm font-medium mb-1">Assigned States</p>
                  <p className="text-white text-3xl sm:text-4xl font-bold">{states.filter(s => s.admin_name).length}</p>
                </div>
              </div>

              {/* Unassigned States Card */}
              <div className="bg-gradient-to-br from-yellow-500 to-yellow-600 rounded-xl shadow-lg p-4 sm:p-6 relative overflow-hidden">
                ...
                <div className="relative z-10">
                  ...
                  <p className="text-yellow-100 text-xs sm:text-sm font-medium mb-1">Unassigned States</p>
                  <p className="text-white text-3xl sm:text-4xl font-bold">{states.filter(s => !s.admin_name).length}</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-4 sm:p-6">
              <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-4">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    <h2 className="text-base sm:text-lg font-semibold text-gray-900">Search & Filter States</h2>
                    <p className="text-xs sm:text-sm text-gray-500">Find states by name or admin</p>
                  </div>
                </div>
                <button
              ...
              <div className="relative">
                ...
                <input
                  type="text"
                  placeholder="Search by state name or admin name..."
                  ...
                  <tbody className="bg-white divide-y divide-gray-200">
                    {paginatedStates.length === 0 ? (
                        ...
                        <td colSpan="3" className="px-6 py-12 text-center">
                          <div className="flex flex-col items-center justify-center">
                            ...
                            <p className="text-gray-500 mb-4">
                              {searchTerm ? "Try adjusting your search terms" : "Get started by creating your first state"}
                            </p>
                            {!searchTerm && (
                              <button
                                onClick={() => setShowCreateModal(true)}
                      ...
                      paginatedStates.map((state) => (
                        <tr key={state.state_id} className="hover:bg-gray-50 transition-colors duration-200">
                          <td className="px-6 py-4 whitespace-nowrap">
                            <div className="flex items-center">
                              ...
                              <div className="ml-4">
                                ...
                                <div className="text-xs text-gray-500">ID: {state.state_id.slice(0, 8)}...</div>
                              </div>
                            </div>
                          </td>
                          <td className="px-6 py-4 whitespace-nowrap">
              ...
              {filteredStates.length > 0 && (
                <div className="flex flex-col sm:flex-row items-center justify-between px-4 sm:px-6 py-4 border-t border-gray-200">
                  ...
                  <div className="text-sm text-gray-500 mb-4 sm:mb-0">
                    ...
                    <span className="font-semibold text-gray-900">{Math.min(endIndex, filteredStates.length)}</span> of{' '}
                    <span className="font-semibold text-gray-900">{filteredStates.length}</span> entries
                  </div>
      ...
      {/* Create State Slide Panel */}
      {showCreateModal && (
        <CreateStateSlidePanel
          isOpen={showCreateModal}
          onClose={() => setShowCreateModal(false)}
          onSuccess={() => {
            // Don't call fetchStates here - let polling handle it
            setShowCreateModal(false);
          }}
        />
      )}

      {/* Edit State Slide Panel */}
