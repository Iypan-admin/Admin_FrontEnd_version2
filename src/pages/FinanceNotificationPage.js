...
import { getFinanceNotifications, markFinanceNotificationAsRead, getCurrentUserProfile } from '../services/Api';

const FinanceNotificationPage = () => {
  ...
  const userName = decodedToken?.full_name || decodedToken?.name || 'Finance Admin';
  ...
  const handleMarkAsRead = async (id) => {
    try {
      await markFinanceNotificationAsRead(id, token);
        ...
        <div className="bg-white border-b border-gray-200 sticky top-0 z-30">
          <div className="px-4 sm:px-6 lg:px-8 py-3 sm:py-4 flex items-center justify-between">
            <div className="flex items-center space-x-3 sm:space-x-4">
              ...
              <div>
                <h1 className="text-xl sm:text-2xl font-bold text-gray-800">Finance Notifications</h1>
...
export default FinanceNotificationPage;
